// Another  Modified errors6.rs - to go through steps of error handling and learn the refactorings instead of jumping to the
...
// Execute `rustlings hint errors7` or use the `hint` watch subcommand for a hint.
